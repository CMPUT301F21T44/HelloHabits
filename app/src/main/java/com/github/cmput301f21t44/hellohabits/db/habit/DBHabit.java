...
public class DBHabit implements Habit {
    @Embedded
    ...
    private List<DBHabitEvent> mHabitEventList;

    public DBHabit() {
    }

    public DBHabit(HabitEntity habit) {
    ...
    public void setHabitEventList(List<DBHabitEvent> mHabitEventList) {
