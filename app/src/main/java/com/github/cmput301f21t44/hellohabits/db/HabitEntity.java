...
public class HabitEntity {
   ...
   */
  @PrimaryKey @NonNull @ColumnInfo(name = "habit_id") private String mHabitId;

  @ColumnInfo(name = "title") @NonNull private final String mTitle;

  @ColumnInfo(name = "reason") @NonNull private final String mReason;

  @ColumnInfo(name = "date_started") @NonNull private final Instant mDateStarted;

  @ColumnInfo(name = "days_of_week") private final boolean[] mDaysOfWeek;

  public HabitEntity(@NonNull String id, @NonNull String title, @NonNull String reason,
      @NonNull Instant dateStarted, @NonNull) {
    this.mHabitId = id;
    this.mTitle = title;
    this.mReason = reason;
